...
const catalog: readonly PermissionLabel[] = [
  ...
  { code: 'platform.settings.manage', displayName: 'Manage platform settings', module: 'Platform', description: 'Change control-plane settings.' },
  ...
  { code: 'deploy.execute', displayName: 'Execute deploys', module: 'Delivery', description: 'Deploy and redeploy an application.', opens: 'Applications' },
  ...
  { code: 'deploy.rollback', displayName: 'Roll back deploys', module: 'Delivery', description: 'Restore the last successful desired state.', opens: 'Applications' },
  ...
  { code: 'runtime.logs.read', displayName: 'Read logs', module: 'Runtime', description: 'Read container logs.', opens: 'Applications' },
